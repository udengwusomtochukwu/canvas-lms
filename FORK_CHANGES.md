...
| `app/models/account.rb` | One `add_setting :k12_result` line + `TAB_K12_RESULT_SETTINGS` account-nav tab (root accounts, manage_account_settings, flag-gated). | **Low** — one-line insert in the tabs list. |
